...
import com.ezyedu.vendor.adapter.CancelledOrderAdapter;
...
public class canceled_sales_fragment extends Fragment {
    ...
    ImageView imageView;
    TextView t1;
    List<cancelled_orders> cancelledOrdersList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_canceled_sales_fragment, container, false);
            ...
            public void onResponse(JSONObject response)
            {
                ...
                try {
                    ...
                    for (int i = 0;i<jsonArray.length();i++)
                    {
                        ...
                        {
                            cancelled_orders post = new cancelled_orders(order_id,order_status,date,course_name,qty,courses_count);
