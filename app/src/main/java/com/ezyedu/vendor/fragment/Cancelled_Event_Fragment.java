...
public class Cancelled_Event_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_cancelled__event_, container, false);
    ...
    {
        String url = base_app_url+"api/event?status=2&expired=0";
