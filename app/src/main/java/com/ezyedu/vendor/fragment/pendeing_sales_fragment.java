...
public class pendeing_sales_fragment extends Fragment {

    RecyclerView recyclerView;
    private RequestQueue requestQueue;
    SharedPreferences sharedPreferences;
    PendingOrderAdapter pendingOrderAdapter;
    List<pending_orders> pendingOrdersList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_pendeing_sales_fragment, container, false);
        ...
        pendingOrderAdapter = new PendingOrderAdapter(getContext(),pendingOrdersList);
            ...
            public void onResponse(JSONObject response)
            {
                ...
                try {
                    ...
                    for (int i = 0;i<jsonArray.length();i++)
                    {
                        ...
                        {
                        pending_orders post = new pending_orders(order_id,order_status,date,course_name,qty,courses_count);
