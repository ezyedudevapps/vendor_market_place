...
public class completed_sales_fragment extends Fragment {
    ...
    ImageView imageView;
    TextView t1;
    List<completed_orders> completedOrdersList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_completed_sales_fragment, container, false);
            ...
            public void onResponse(JSONObject response)
            {
                ...
                try {
                    ...
                    for (int i = 0;i<jsonArray.length();i++)
                    {
                        ...
                        if (order_status == 4)
                        {
                            completed_orders post = new completed_orders(order_id,order_status,date,course_name,qty,courses_count);
