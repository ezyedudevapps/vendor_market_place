...
import com.ezyedu.vendor.Add_Event_Activity;
import com.ezyedu.vendor.Add_Events_Activity;
import com.ezyedu.vendor.R;
import com.ezyedu.vendor.adapter.Approved_Event_Adapter;
import com.ezyedu.vendor.adapter.CompletedOrderAdapter;
...
public class Approved_Event_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_approved__event_, container, false);
        requestQueue= Volley.newRequestQueue(getContext());
        recyclerView = view.findViewById(R.id.approved_event_recycler);
        button = view.findViewById(R.id.add_prod);
    ...
    {
        String url = base_app_url+"api/event?status=1&expired=0";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Log.i("ResponseEvents",response.toString());
                try {
