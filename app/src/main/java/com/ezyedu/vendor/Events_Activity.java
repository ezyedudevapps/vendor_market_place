...
import com.ezyedu.vendor.adapter.Event_Fragment_Adapter;
...
public class Events_Activity extends AppCompatActivity {
    ...
    Event_Fragment_Adapter event_fragment_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        event_fragment_adapter = new Event_Fragment_Adapter(fragmentManager,getLifecycle());
        pager2.setAdapter(event_fragment_adapter);
        tableLayout.addTab(tableLayout.newTab().setText("Approved"));
