...
public class Sales_activity extends AppCompatActivity {
    ...
    Sales_fragment_Adapter sales_fragment_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Sales History");
        ...
        sales_fragment_adapter = new Sales_fragment_Adapter(fragmentManager,getLifecycle());
        pager2.setAdapter(sales_fragment_adapter);
