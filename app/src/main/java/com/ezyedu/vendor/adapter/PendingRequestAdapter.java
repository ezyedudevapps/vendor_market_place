...
public class PendingRequestAdapter extends RecyclerView.Adapter<PendingRequestAdapter.PendingRequestHolder> {
    ...
    public PendingRequestAdapter(Context context, List<PendingRequests> pendingRequestsList) {
    ...
    public PendingRequestHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pending_request_adapter,parent,false);
    ...
    {
        PendingRequests a = pendingRequestsList.get(position);
    ...
    public int getItemCount() {
        return pendingRequestsList == null ?0: pendingRequestsList.size();
    }
